 ...
 * that context unconditionally — so this row is **scope-only**. Mounted inside
...
/**
 * Register the persona context for the mounting context's scope.
 ...
 * @param config - the persona text contributed to the dynamic context.
 */
