...
const TOOLS_BY_PACKAGE: Readonly<Record<string, readonly string[]>> = {
  ...
  '@deepseek-ai/dsh-tool-session-delivery': ['session_message', 'session_send_message', 'session_unload'],
  '@deepseek-ai/dsh-tool-session-query': ['session_event_read', 'session_event_search', 'session_event_trace', 'session_find', 'session_inspect', 'session_log_tail', 'session_message_tail', 'session_search', 'session_status', 'session_trace'],
