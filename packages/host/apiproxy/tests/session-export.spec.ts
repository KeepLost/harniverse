...
describe('stream queue config', () => {
  it('accepts positive frame bounds and rejects zero, negative, and fractional values', () => {
    expect(ApiProxyService.Config({ streamQueueMaxFrames: 8 })).toEqual({
      sessionExportCompressionLevel: 6,
      coldBlankProbeMaxBytes: 1024,
