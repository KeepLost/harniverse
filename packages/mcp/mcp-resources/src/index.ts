...
/**
 * Prompt order shared with the mcp-client server-context sections
 * (`mcp:<server>`): after plan policy (50), before per-tool guidance
 * (100–199).
 */
export const MCP_SECTION_ORDER = 60
