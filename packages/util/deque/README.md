...
- [Ring queue sizing](../../../.agents/notes/implemented/process/2026-09-05-api-catalog-and-ring-queues.md) — where the catalog generator applies fixed ring buffers built on array-backed queues.
