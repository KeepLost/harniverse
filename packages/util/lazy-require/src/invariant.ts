...
/**
 * No runtime invariant: this load-timing utility owns no event stream or mutable runtime
 * state; its caching and resolution semantics are enforced by unit tests.
 */
