...
| [`code-runtime-worker-thread/`](code-runtime-worker-thread/README.md) | TypeScript worker 线程后端 | 注册 `ctx.codeRuntime` |
| [`code-runtime-python/`](code-runtime-python/README.md) | 显式选择的 Python 进程后端 | 注册 `ctx.codeRuntime` |
