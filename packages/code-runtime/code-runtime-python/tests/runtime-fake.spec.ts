...
describe('PythonCodeRuntime deterministic process boundary', () => {
  ...
  it('rejects invalid, duplicate, reserved, and unusable binding descriptors', async () => {
    ...
    const cases: [CodeBindingNamespace[], RegExp][] = [
      ...
      [[{ global: 'console', functions: {} } as CodeBindingNamespace], /reserved binding global/],
      [[{ global: 'tools', functions: {}, errorClass: { name: 'lambda', memberNameProperty: 'toolName' } } as CodeBindingNamespace], /error class/],
      [[{ global: 'tools', functions: {}, errorClass: { name: 'console', memberNameProperty: 'toolName' } } as CodeBindingNamespace], /reserved binding global/],
