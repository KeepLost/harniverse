...
- **No hard security-boundary backend ships** — the worker-thread and Python process providers are same-host containment; `'container'` remains a declared `isolation` value without an implementation.
