...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-input-trigger CommandSeat',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.input.commands\', () => ctx.slots.register(\n      { name: \'conversation.input.commands\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-input-trigger/src/client/slots.ts:38',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-scheduler ScheduleListAction id \'schedule-list\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace WorkspaceWorkbenchButton id \'workspace-workbench\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-capabilities SessionCapabilitiesView id \'capabilities\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins CompactionCard id \'compaction\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-settings-capabilities CapabilityCompositionTab id \'capabilities\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace WorkspaceWorkbenchPreviewOverlay id \'workspace-workbench-preview\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'sidebar.header.status',
    kind: 'single',
    scope: 'root',
    summary: 'Read-only connection status between the brand and sidebar toggle.',
    doc: 'Read-only connection status between the brand and sidebar toggle.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-connection-status StatusIcon',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Workspace-oriented root surface sharing the physical right region with details.',
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workspace WorkspaceWorkbench',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'workbench.section.panel',
    kind: 'list',
    scope: 'root',
    summary: 'One contributed section body inside the workbench\'s tabpanel (rendered by the workbench entry\'s children).',
    doc: 'One contributed section body inside the workbench\'s tabpanel (rendered\nby the workbench entry\'s children). Registrants render null while\nanother section shows and their own surface otherwise; `request`\ncarries an opener\'s ask (the browser section\'s destination URL)\nverbatim.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'workbench\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-browser BrowserPanelView id \'browser\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'workbench\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-browser BrowserSectionTab id \'browser\'',
      'client-ui-terminal TerminalSectionTab id \'terminal\'',
    ],
    replaceRisk: 'none',
