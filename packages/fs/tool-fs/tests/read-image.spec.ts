 ...
 * extension routing, extension-less content sniffing, the strict
...
describe('image admission failures', () => {
  ...
  it('rethrows a non-attachment store failure from the durable save unchanged', async () => {
    /** Store whose persistence layer fails with its own error type. */
