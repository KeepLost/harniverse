...
| `maxTokens` | no (default `8192`) | Upper bound for the summarization call; the selected model cap and remaining context window can reduce it. May include reasoning tokens. |
