 ...
 * restrict() and a scoped shadowing persona context).
 */
class ForkInProcessProvider implements SubagentProvider {
  ...
  // Continuable fork creation captures the parent's completed-turn prefix once.
  // Child-scoped prompt or tool contributions may precede that prefix and
  // therefore prevent byte-identical prefix reuse without changing semantics.
