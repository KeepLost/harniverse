...
- **Skill/MCP members and route fallback remain Host work** — Profiles currently enforce primary model route, workspace, Tool, and depth/token bounds; native Skill/MCP projection and multi-route fallback/scheduler execution are not yet exposed by this Consumer.
