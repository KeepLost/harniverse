...
- **Durable records are top-level and observational** — nested PTC dispatches are not recorded, and a recording failure intentionally degrades to an incomplete prefix rather than changing execution.
