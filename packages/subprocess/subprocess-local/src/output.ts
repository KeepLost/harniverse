 ...
 * the in-memory tail window, the lazily created spill file, and the shared
 * private spill directory.
 * @module dsh-subprocess-local/output
 */
 ...
 * @returns the absolute private spill directory for this process.
 */
