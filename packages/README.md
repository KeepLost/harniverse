...
| [`code-runtime/`](code-runtime/README.md) | Code-execution capability family: Service Definition + worker-thread/Python providers + Code Mode Consumer | Product — stable API |
| [`sandbox/`](sandbox/README.md) | Process-confinement seam; bwrap/Landlock/Seatbelt backends | Product — stable API |
| [`ssh/`](ssh/README.md) | POSIX SSH provider family: shared connection, remote filesystem, subprocess and sandbox providers | Product — stable API |
...
| [`auth/`](auth/README.md) | Inbound principal/capability seam + public-key Grant Provider | Product — stable API |
