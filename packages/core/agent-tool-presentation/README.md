...
- **The runtime stays host-plane** — a preset can select PTC but cannot supply the runtime it needs; a deployment that composes none can compose no PTC preset.
