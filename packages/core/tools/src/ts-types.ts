...
/** Internal PTC projection: the model-facing schema plus the canonical output schema. */
...
/** The fixed model-facing usage contract rendered above the declarations (see the PTC Agent Note's "What the model sees"). */
