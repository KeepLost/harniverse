/**
 * PTC `run_code` transport. Programs call the registry's agent-visible
...
import type { CodeBindingFunction, CodeRunResult, PtcRuntime } from '@deepseek-ai/dsh-ptc-runtime'
...
/** The model-facing name of the PTC tool. */
...
/**
 * The languages PTC ships a presentation for. Both per-language tables —
...
/** Canonical value returned by the outer PTC transport. */
