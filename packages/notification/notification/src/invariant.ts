...
/**
 * No runtime invariant: the Service Definition owns no registry or durable
 * state, and its complete output is a synchronous provider handoff after
 * validating and copying one envelope.
 */
