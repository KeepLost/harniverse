/** Real HTTP coverage proves native `fetch` does not contact a cross-origin `Location`. */
...
describe('PerplexitySearchProvider redirect policy', () => {
  ...
  it('shows default 307 following forwards the POST body', async () => {
    targetRequests.length = 0
