 ...
 * @module @deepseek-ai/dsh-ptc-runtime-node/src/child
 */
...
async function main(): Promise<void> {
  // Executable selection and heap flags have already been consumed. Programs
  // and their subprocesses receive none of the host's bootstrap controls.
  delete process.env.ELECTRON_RUN_AS_NODE
  delete process.env.DSH_PTC_RUNTIME_NODE
