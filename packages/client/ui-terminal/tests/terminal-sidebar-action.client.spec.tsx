...
/**
 * The terminal panel's sidebar footer trigger: the wide row and rail
...
import { TerminalSidebarAction, type TerminalSidebarActionProps } from '../src/client/TerminalSidebarAction.tsx'
...
const t: TerminalSidebarActionProps['t'] = makeTranslate(zh)
  ...
  render(
    <TerminalSidebarAction
      {...{
        ...
        openView,
        t,
      } as unknown as TerminalSidebarActionProps}
    />,
  )
  return { instance, openView }
}

describe('TerminalSidebarAction', () => {
