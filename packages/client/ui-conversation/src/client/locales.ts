...
export const zh = {
  ...
  'placeholder.default': '给智能体发消息；Shift+Enter 换行，Enter / Ctrl+Enter 发送',
  ...
  'input.supervisionMode': '值守模式：{name}',
  ...
  'file.uploadInProgress': '文件仍在上传，请等待上传完成后再发送',
  'file.tooLarge': '文件超过大小上限，无法上传',
  'file.invalid': '文件无效，请重新选择',
  'file.forbidden': '没有上传文件的权限',
  'file.networkError': '网络异常，文件上传失败',
  'file.failed': '文件上传失败',
  'file.readFailed': '文件校验失败，请重新上传后再发送',
  'file.invalidRef': '文件引用无效，请重新添加文件',
  'file.badges': '已发送文件',
  ...
  'settings.links.title': '链接打开位置',
  'settings.links.description': '宿主机浏览器可访问其内网与本机服务；本机浏览器则在新标签页中打开',
  'settings.links.panel': '宿主机浏览器',
  'settings.links.device': '本机浏览器',
  ...
  'supervision.mode.supervised': '随时监督',
  'supervision.mode.supervised.description': '允许已配置的用户提问与审批请求，关键决策会等你确认。',
  'supervision.mode.unsupervised': '无人值守',
  'supervision.mode.unsupervised.description': '无需等待人工决策，自主继续执行任务。',
  'hero.headline': '探索未至之境',
  'hero.preview': '预览版',
  'hero.chooseWorkspace': '选择工作区',
  'hero.openWorkbench': '打开工作台',
  ...
  'message.context.snapshot.partial': '运行时上下文有部分更新。',
  ...
  'message.compaction.progress.title': '正在压缩上下文',
  'message.compaction.progress.preparing': '准备中',
  'message.compaction.progress.reasoning': '思考摘要',
  'message.compaction.progress.summary': '生成摘要',
  'message.compaction.progress.elapsed': '{seconds}秒',
  'message.compaction.progress.toggle': '展开或收起压缩过程',
  'message.compaction.progress.failedTitle': '压缩失败',
  'message.compaction.progress.failed': '未应用摘要',
  'message.compaction.progress.waiting': '等待模型输出',
...
export const en = {
  ...
  'input.supervisionMode': 'Supervision mode: {name}',
  ...
  'file.pending': 'Files to send',
  'file.remove': 'Remove file {name}',
  'file.uploading': 'Uploading file',
  'file.uploadInProgress': 'Files are still uploading; wait for them to finish before sending',
  'file.tooLarge': 'Files must be under the size limit',
  'file.invalid': 'The file is invalid; choose it again',
  'file.forbidden': 'You do not have permission to upload files',
  'file.networkError': 'Network error; the file upload failed',
  'file.failed': 'The file upload failed',
  'file.readFailed': 'The file failed verification; upload it again before sending',
  'file.invalidRef': 'The file reference is invalid; re-add the file',
  'file.badges': 'Sent files',
  ...
  'settings.links.title': 'Where links open',
  'settings.links.description': 'The host browser reaches the host\u2019s own network; your browser opens a new tab',
  'settings.links.panel': 'Host browser',
  'settings.links.device': 'Your browser',
  ...
  'supervision.mode.supervised.description': 'Allow configured user questions and approval requests.',
  'supervision.mode.unsupervised': 'Unsupervised',
  'supervision.mode.unsupervised.description': 'Continue independent work without waiting for human decisions.',
  'hero.headline': 'Into the Unknown',
  'hero.preview': 'Preview',
  'hero.chooseWorkspace': 'Choose workspace',
  'hero.openWorkbench': 'Open workbench',
  ...
  'message.systemInjection': 'System injection',
  ...
  'message.context.snapshot.partial': 'Runtime context has partial updates.',
  ...
  'message.compaction.progress.title': 'Compacting context',
  'message.compaction.progress.preparing': 'Preparing',
  'message.compaction.progress.reasoning': 'Thinking',
  'message.compaction.progress.summary': 'Writing summary',
  'message.compaction.progress.elapsed': '{seconds}s',
  'message.compaction.progress.toggle': 'Expand or collapse compaction progress',
  'message.compaction.progress.failedTitle': 'Compaction failed',
  'message.compaction.progress.failed': 'Summary not applied',
  'message.compaction.progress.waiting': 'Waiting for model output',
