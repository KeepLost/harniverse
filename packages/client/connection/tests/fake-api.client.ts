...
export class FakeApiClient implements IApiClient {
  ...
  readonly events: IApiClient['events'] = {
    ...
    terminal: (_payload: unknown, signal: AbortSignal, onOpen?: () => void, onAuthenticated?: (identity: TestAuthenticationIdentity) => void) =>
      this.openStream(this.terminalConns, signal, onOpen, onAuthenticated, BYPASS_IDENTITY),
    hold: (_payload: unknown, signal: AbortSignal, onOpen?: () => void, onAuthenticated?: (identity: TestAuthenticationIdentity) => void) =>
