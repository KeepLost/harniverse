...
import { GovernorResourcesTab, type GovernorResourcesTabProps } from '../src/client/GovernorResourcesTab.tsx'
...
const t: GovernorResourcesTabProps['t'] = makeTranslate(zh)
...
/** Mount the tab with a stubbed Remote face. */
  ...
  render(
    <GovernorResourcesTab
      {...{
        ...
        pollMs,
        t,
      } as unknown as GovernorResourcesTabProps}
    />,
  )
  return { calls, fetchOverview }
}

describe('GovernorResourcesTab', () => {
