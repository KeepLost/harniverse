...
import type {
  ArbitrateKey, ArbitrateOutcome, ClientSessionContext, PickOutcome, InputTriggerSource, SubmitEnvelope, TriggerChar,
  TriggerGuard,
} from '../types.ts'
...
export class InputTriggerController {
   ...
   * polled source refuses the complete envelope or its warmup fails.
   */
