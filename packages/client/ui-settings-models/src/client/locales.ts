...
export const en = {
  ...
  modelReasoning: 'Supports reasoning (thinking)',
  modelEfforts: 'Thinking levels',
  modelEffortWire: 'Wire value',
  modelEffortOffDefault: 'sends nothing',
  modelDefaultEffort: 'Default thinking level',
  modelDefaultEffortUnset: 'Not set (uses the route default)',
  modelDefaultEffortNone: 'Default (send no effort)',
  modelThinkingFormat: 'Thinking dispatch format',
  modelFormatAuto: 'Auto (detected from the base URL)',
  modelKwargs: 'Custom thinking fields (chat_template_kwargs)',
  modelKwargName: 'Field name',
  modelKwargKind: 'Value kind',
  modelKwargLiteral: 'Literal value',
  modelKwargValue: 'Value',
  modelKwargThinkingEnabled: 'Follows thinking on/off',
  modelKwargThinkingEffort: 'Follows thinking level',
  modelKwargOmitWhenOff: 'Omit when off',
  modelKwargAdd: 'Add field',
  modelEffortsInvalid: 'Declare at least one thinking level besides off.',
  modelDefaultEffortInvalid: 'The default thinking level must be one of the declared levels.',
  modelKwargNameRequired: 'Every custom thinking field needs a name.',
  addModel: 'Add model',
  ...
  fetchFromEndpoint: 'Query the endpoint',
  ...
  customApiInherit: 'Per-model (inherit the catalog)',
  modelApi: 'API protocol',
  modelApiInherit: 'Inherit the route',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelImageInput: '接受图像输入',
  modelReasoning: '支持推理（思考）',
  modelEfforts: '思考档位',
  modelEffortWire: '线上取值',
  modelEffortOffDefault: '不发送',
  modelDefaultEffort: '默认思考档位',
  modelDefaultEffortUnset: '未设置（沿用路由默认）',
  modelDefaultEffortNone: '默认（不发送思考参数）',
  modelThinkingFormat: '思考分派格式',
  modelFormatAuto: '自动（按 API 地址嗅探）',
  modelKwargs: '自定义思考字段（chat_template_kwargs）',
  modelKwargName: '字段名',
  modelKwargKind: '值类型',
  modelKwargLiteral: '固定值',
  modelKwargValue: '值',
  modelKwargThinkingEnabled: '随思考开关变化',
  modelKwargThinkingEffort: '随思考档位变化',
  modelKwargOmitWhenOff: '关闭时省略',
  modelKwargAdd: '添加字段',
  modelEffortsInvalid: '除 off 外至少勾选一个思考档位。',
  modelDefaultEffortInvalid: '默认思考档位必须是已勾选的档位之一。',
  modelKwargNameRequired: '每个自定义思考字段都需要字段名。',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  customApi: 'API 协议',
  customApiUnset: '未选择',
  customApiInherit: '逐模型（继承目录）',
  modelApi: 'API 协议',
  modelApiInherit: '继承路由设置',
  sourceCatalog: '目录',
