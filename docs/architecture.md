...
| Change capabilities for future sessions | edit the Agent Profile assembly; its recipe plan compiles load/unload selections into the next immutable generation |
