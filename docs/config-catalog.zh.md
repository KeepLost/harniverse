...
- `@deepseek-ai/dsh-host-capability-management` — 需要 `capabilities` · `agentPresets` · `agents` · `subagents`（[`packages/host/capability-management/src/index.ts`](../packages/host/capability-management/src/index.ts)）
