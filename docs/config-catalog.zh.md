...
来源：[`packages/core/agent-loop/src/index.ts:258`](../packages/core/agent-loop/src/index.ts)
...
需要：`clientModules` · `webServer` · `connection`
...
```ts config-catalog
/** Local file-reference provider configuration. */
export interface Config {
  /** Maximum candidates returned by one completion request. @default 20 */
  maxResults?: number
  /** Maximum indexed entries for fuzzy root queries. @default 10000 */
  maxEntries?: number
  /** Directory basenames excluded from traversal and completion. @default ['.git', 'node_modules'] */
  excludedDirectories?: string[]
}
```

来源：[`packages/context/file-reference-local/src/index.ts:17`](../packages/context/file-reference-local/src/index.ts)
...
需要：`agents` · `sessions` · `storageDomain`
...
来源：[`packages/hooks/hooks-claude-code/src/index.ts:50`](../packages/hooks/hooks-claude-code/src/index.ts)
...
来源：[`packages/hooks/hooks-codex/src/index.ts:49`](../packages/hooks/hooks-codex/src/index.ts)
...
来源：[`packages/ptc-runtime/ptc-runtime-node/src/index.ts:30`](../packages/ptc-runtime/ptc-runtime-node/src/index.ts)
...
来源：[`packages/ptc-runtime/ptc-runtime-python/src/index.ts:23`](../packages/ptc-runtime/ptc-runtime-python/src/index.ts)
...
来源：[`packages/session/session-persistence-sqlite/src/index.ts:90`](../packages/session/session-persistence-sqlite/src/index.ts)
...
来源：[`packages/skill/skill/src/index.ts:261`](../packages/skill/skill/src/index.ts)
...
来源：[`packages/deliverables/tool-present/src/index.ts:27`](../packages/deliverables/tool-present/src/index.ts)
...
来源：[`packages/session-query/tool-session-query/src/index.ts:37`](../packages/session-query/tool-session-query/src/index.ts)
...
来源：[`packages/skill/tool-skill/src/index.ts:59`](../packages/skill/tool-skill/src/index.ts)
...
来源：[`packages/todo/tool-todo/src/index.ts:32`](../packages/todo/tool-todo/src/index.ts)
...
export interface Config {
  ...
  /** Upper bound on queries accepted by one `web_search` call; maximum 16. */
...
来源：[`packages/web/web/src/index.ts:65`](../packages/web/web/src/index.ts)
...
来源：[`packages/bundle/web-app/src/index.ts:33`](../packages/bundle/web-app/src/index.ts)
...
来源：[`packages/web/web-firecrawl/src/index.ts:45`](../packages/web/web-firecrawl/src/index.ts)
...
来源：[`packages/web/web-search-brave/src/index.ts:33`](../packages/web/web-search-brave/src/index.ts)
...
来源：[`packages/web/web-search-kagi/src/index.ts:29`](../packages/web/web-search-kagi/src/index.ts)
...
来源：[`packages/web/web-search-perplexity/src/index.ts:37`](../packages/web/web-search-perplexity/src/index.ts)
...
来源：[`packages/web/web-search-tavily/src/index.ts:33`](../packages/web/web-search-tavily/src/index.ts)
...
- `@deepseek-ai/dsh-session-delivery` — 抽象 `SessionDelivery`（[`packages/session-query/session-delivery/src/index.ts`](../packages/session-query/session-delivery/src/index.ts)）
