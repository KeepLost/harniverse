...
```sh
pnpm dsh --profile web --patch ./scratch-plugin/cordis.yml
```
...
- [Tool authoring reference](../../../cookbook/adding-a-tool.md) — look up nested schemas, canonical values, background work, policy hooks, PTC, and UI cards.
