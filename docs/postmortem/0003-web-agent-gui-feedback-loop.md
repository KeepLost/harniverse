...
- The Web launcher publishes the canonical loopback URL and actual production/development mode in the logged `app:web-surface` dynamic context and managed `$DSH_WEB_URL`/`$DSH_WEB_MODE` environment.
