...
- `@deepseek-ai/dsh-host-capability-management` — requires `capabilities` · `agentPresets` · `agents` · `subagents` ([`packages/host/capability-management/src/index.ts`](../packages/host/capability-management/src/index.ts))
