...
Requires: `subprocess` · `sandboxPolicy`
...
Source: [`packages/attachment/attachment-local/src/index.ts:40`](../packages/attachment/attachment-local/src/index.ts)

<a id="deepseek-aidsh-auth-app"></a>

## `@deepseek-ai/dsh-auth-app`

Requires: `authStartup`
...
Source: [`packages/bundle/auth-app/src/index.ts:30`](../packages/bundle/auth-app/src/index.ts)
...
Source: [`packages/auth/authentication-local/src/index.ts:74`](../packages/auth/authentication-local/src/index.ts)
...
Source: [`packages/client/ui-browser/src/index.ts:15`](../packages/client/ui-browser/src/index.ts)
...
Source: [`packages/compaction/compaction-lossless/src/index.ts:46`](../packages/compaction/compaction-lossless/src/index.ts)
...
Source: [`packages/compaction/compaction-settings/src/index.ts:11`](../packages/compaction/compaction-settings/src/index.ts)
...
Source: [`packages/context/file-reference-local/src/index.ts:17`](../packages/context/file-reference-local/src/index.ts)
...
Requires: `agentDefaultModel` · `modelPolicy` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `subagents` · `sessionQuery` · `tools` · `userQuestions` · `workspaceRegistry`
...
Source: [`packages/host/webserver/src/index.ts:50`](../packages/host/webserver/src/index.ts)
...
Source: [`packages/core/model-policy/src/index.ts:67`](../packages/core/model-policy/src/index.ts)

<a id="deepseek-aidsh-model-policy-fallback"></a>

## `@deepseek-ai/dsh-model-policy-fallback`

Requires: `agents` · `modelPolicy` · `sessions`
...
Source: [`packages/core/model-policy-fallback/src/index.ts:17`](../packages/core/model-policy-fallback/src/index.ts)
...
Depends on: [`NotificationTurnReason`](../packages/notification/notification/src/index.ts)

Source: [`packages/notification/notification-http/src/index.ts:50`](../packages/notification/notification-http/src/index.ts)
...
Source: [`packages/session/session-persistence-jsonl/src/index.ts:171`](../packages/session/session-persistence-jsonl/src/index.ts)
...
Source: [`packages/session/session-persistence-sqlite/src/index.ts:92`](../packages/session/session-persistence-sqlite/src/index.ts)
...
Source: [`packages/skill/skill/src/index.ts:291`](../packages/skill/skill/src/index.ts)
...
Source: [`packages/interaction/supervision/src/index.ts:70`](../packages/interaction/supervision/src/index.ts)
...
Source: [`packages/core/system-prompt/src/index.ts:202`](../packages/core/system-prompt/src/index.ts)
...
Source: [`packages/terminal/terminal-bash/src/config.ts:9`](../packages/terminal/terminal-bash/src/config.ts)
...
Source: [`packages/shell/tool-bash-persistent/src/index.ts:407`](../packages/shell/tool-bash-persistent/src/index.ts)

<a id="deepseek-aidsh-tool-compaction-history"></a>

## `@deepseek-ai/dsh-tool-compaction-history`

Requires: `tools` · `systemPrompt` · `compactionHistory`
...
Source: [`packages/compaction/tool-compaction-history/src/index.ts:25`](../packages/compaction/tool-compaction-history/src/index.ts)
...
Source: [`packages/shell/tool-pwsh-persistent/src/index.ts:419`](../packages/shell/tool-pwsh-persistent/src/index.ts)
...
Source: [`packages/spill/tool-result-artifacts/src/index.ts:44`](../packages/spill/tool-result-artifacts/src/index.ts)
...
Source: [`packages/bundle/web-app/src/index.ts:33`](../packages/bundle/web-app/src/index.ts)
