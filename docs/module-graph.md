...
flowchart TD
  ...
  subgraph group_compaction["packages/compaction"]
    ...
    pkg_image_offload_policy["image-offload-policy"]
  ...
  subgraph group_context["packages/context"]
    ...
    pkg_command_context["command-context"]
    ...
    pkg_harness_source["harness-source"]
  ...
  subgraph group_monitor["packages/monitor"]
  ...
  subgraph group_queue["packages/queue"]
    pkg_queue["queue"]
  end
  ...
  subgraph group_sandbox["packages/sandbox"]
    pkg_execution_descriptor["execution-descriptor"]
    pkg_sandbox["sandbox"]
  ...
  subgraph group_schedule["packages/schedule"]
    ...
    pkg_tool_scheduler["tool-scheduler"]
  end
  ...
  subgraph group_subprocess["packages/subprocess"]
    pkg_control_channel["control-channel"]
  ...
  pkg_lazy_require --> pkg_invariants
  ...
  pkg_client_ui_queue --> pkg_invariants
  ...
  pkg_lsp --> pkg_llm
  pkg_execution_descriptor --> pkg_capabilities
  pkg_execution_descriptor --> pkg_credentials
  pkg_execution_descriptor --> pkg_invariants
  ...
  pkg_app_boot --> pkg_hmr_coordination
  ...
  pkg_compaction_image_offload --> pkg_compaction_settings
  pkg_compaction_image_offload --> pkg_image_offload_policy
  pkg_compaction_image_offload --> pkg_invariants
  ...
  pkg_command_context --> pkg_commands
  pkg_command_context --> pkg_context_inspector
  pkg_command_context --> pkg_invariants
  pkg_context_reset --> pkg_agent
  pkg_context_reset --> pkg_brand
  pkg_context_reset --> pkg_commands
  pkg_context_reset --> pkg_invariants
  pkg_context_reset --> pkg_llm
  pkg_context_reset --> pkg_session
  ...
  pkg_command_reset --> pkg_commands
  pkg_command_reset --> pkg_context_reset
  pkg_command_reset --> pkg_invariants
  pkg_context_snapshot --> pkg_agent
  pkg_context_snapshot --> pkg_compaction
  pkg_context_snapshot --> pkg_invariants
  pkg_context_snapshot --> pkg_llm
  pkg_context_snapshot --> pkg_session
  pkg_context_snapshot --> pkg_system_prompt
  ...
  pkg_scheduler --> pkg_agent
  pkg_scheduler --> pkg_agent_default_model
  pkg_scheduler --> pkg_agent_presets
  pkg_scheduler --> pkg_context_reset
  pkg_scheduler --> pkg_invariants
  pkg_scheduler --> pkg_llm
  pkg_scheduler --> pkg_session
  pkg_scheduler --> pkg_session_persistence
  pkg_scheduler --> pkg_storage_domain
  pkg_scheduler --> pkg_system_prompt
  pkg_scheduler --> pkg_typert_protocol
  pkg_session_import --> pkg_invariants
  ...
  pkg_tool_present --> pkg_invariants
  ...
  pkg_mcp_resources --> pkg_invariants
  pkg_mcp_resources --> pkg_llm
  pkg_mcp_resources --> pkg_scope
  pkg_mcp_resources --> pkg_system_prompt
  pkg_mcp_resources --> pkg_tools
  pkg_governor --> pkg_invariants
  pkg_governor --> pkg_llm
  pkg_governor --> pkg_session
  pkg_governor --> pkg_settings
  pkg_governor --> pkg_storage_domain
  pkg_governor --> pkg_subprocess
  pkg_governor --> pkg_tools
  pkg_governor --> pkg_typert_protocol
  pkg_queue --> pkg_agent
  pkg_queue --> pkg_invariants
  pkg_queue --> pkg_llm
  pkg_queue --> pkg_session
  pkg_queue --> pkg_storage_domain
  pkg_queue --> pkg_tools
  pkg_queue --> pkg_typert_protocol
  pkg_queue --> pkg_workspace
  pkg_tool_scheduler --> pkg_invariants
  pkg_tool_scheduler --> pkg_scheduler
  pkg_tool_scheduler --> pkg_tools
  ...
  pkg_agent_loop_testkit --> pkg_context_snapshot
  ...
  pkg_agent_spine_demo --> pkg_context_snapshot
  ...
  pkg_remote_mock --> pkg_invariants
  ...
  pkg_client_ui_connection_status --> pkg_client_ui_primitives
  pkg_client_ui_connection_status --> pkg_client_ui_sidebar
  ...
  pkg_client_ui_governor --> pkg_api_remotes
  pkg_client_ui_governor --> pkg_client_locale
  pkg_client_ui_governor --> pkg_client_runtime
  pkg_client_ui_governor --> pkg_client_ui_layout
  pkg_client_ui_governor --> pkg_client_ui_primitives
  pkg_client_ui_governor --> pkg_client_ui_settings
  pkg_client_ui_governor --> pkg_client_ui_sidebar
  ...
  pkg_client_ui_scheduler --> pkg_client_ui_conversation
  pkg_client_ui_scheduler --> pkg_client_ui_layout
  pkg_client_ui_scheduler --> pkg_client_ui_primitives
  pkg_client_ui_scheduler --> pkg_client_ui_sidebar
...
| [`lazy-require`](../packages/util/lazy-require) | `util` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`client-ui-queue`](../packages/client/ui-queue) | `client` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`execution-descriptor`](../packages/sandbox/execution-descriptor) | `sandbox` | [`capabilities`](../packages/capability/capabilities), [`credentials`](../packages/credentials/credentials), [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`compaction-image-offload`](../packages/compaction/compaction-image-offload) | `compaction` | [`agent`](../packages/core/agent), [`compaction-settings`](../packages/compaction/compaction-settings), [`image-offload-policy`](../packages/compaction/image-offload-policy), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session) |
...
| [`command-reset`](../packages/context/command-reset) | `context` | [`commands`](../packages/interaction/commands), [`context-reset`](../packages/context/context-reset), [`invariants`](../packages/runtime-diagnostics/invariants) |
| [`context-snapshot`](../packages/context/context-snapshot) | `context` | [`agent`](../packages/core/agent), [`compaction`](../packages/compaction/compaction), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt) |
...
| [`session-import`](../packages/session/session-import) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`supervision`](../packages/interaction/supervision) |
...
| [`ssh`](../packages/ssh/ssh) | `ssh` | [`brand`](../packages/util/brand), [`capabilities`](../packages/capability/capabilities), [`credentials`](../packages/credentials/credentials), [`execution-descriptor`](../packages/sandbox/execution-descriptor), [`fs`](../packages/fs/fs), [`fs-sandbox`](../packages/fs/fs-sandbox), [`invariants`](../packages/runtime-diagnostics/invariants), [`sandbox`](../packages/sandbox/sandbox), [`sandbox-local`](../packages/sandbox/sandbox-local), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`session-projection`](../packages/session/session-projection), [`subprocess`](../packages/subprocess/subprocess), [`subprocess-local`](../packages/subprocess/subprocess-local) |
...
| [`tool-present`](../packages/deliverables/tool-present) | `deliverables` | [`agent`](../packages/core/agent), [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`tools`](../packages/core/tools) |
...
| [`mcp-resources`](../packages/mcp/mcp-resources) | `mcp` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`scope`](../packages/core/scope), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
| [`governor`](../packages/monitor/governor) | `monitor` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`storage-domain`](../packages/storage/storage-domain), [`subprocess`](../packages/subprocess/subprocess), [`tools`](../packages/core/tools), [`typert-protocol`](../packages/typert/protocol) |
| [`queue`](../packages/queue/queue) | `queue` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`storage-domain`](../packages/storage/storage-domain), [`tools`](../packages/core/tools), [`typert-protocol`](../packages/typert/protocol), [`workspace`](../packages/workspace/workspace) |
| [`tool-scheduler`](../packages/schedule/tool-scheduler) | `schedule` | [`invariants`](../packages/runtime-diagnostics/invariants), [`scheduler`](../packages/schedule/scheduler), [`tools`](../packages/core/tools) |
...
| [`subprocess-ssh`](../packages/ssh/subprocess-ssh) | `ssh` | [`invariants`](../packages/runtime-diagnostics/invariants), [`ssh`](../packages/ssh/ssh), [`subprocess`](../packages/subprocess/subprocess), [`subprocess-local`](../packages/subprocess/subprocess-local) |
