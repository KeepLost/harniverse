...
来源：[`packages/compaction/compaction/src/types.ts:73`](../packages/compaction/compaction/src/types.ts)
...
来源：[`packages/compaction/image-offload-policy/src/types.ts:65`](../packages/compaction/image-offload-policy/src/types.ts)
