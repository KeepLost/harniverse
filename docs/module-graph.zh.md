...
flowchart TD
  ...
  pkg_ptc_runtime_python --> pkg_ptc_runtime
  pkg_ptc_runtime_python --> pkg_session
  pkg_ptc_runtime_python --> pkg_timeout
  ...
  pkg_ptc_runtime_node --> pkg_control_channel
  pkg_ptc_runtime_node --> pkg_invariants
