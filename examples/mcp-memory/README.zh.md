...
```sh
dsh --profile web --patch "$PWD/examples/mcp-memory/memorix.cordis.yml"
```
...
dsh --profile web --patch "$PWD/examples/mcp-memory/mcp-reference-memory.cordis.yml"
```
...
dsh --profile web --patch "$PWD/examples/mcp-memory/engram.cordis.yml"
```
