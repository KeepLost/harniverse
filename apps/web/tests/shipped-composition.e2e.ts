 ...
 * sandbox row confines, both Web tools require an explicit deployment routing
 * policy, and `mcp_*` servers spawn outside `ctx.shell`. The composition Agent
 * Note owns the rationale and its sources.
 */
