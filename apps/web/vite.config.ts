...
const DEFAULT_CLIENT_TITLE = 'Harniverse Local Build'
...
function clientDocumentTitle(): Plugin {
  ...
  return {
    name: 'harniverse-client-document-title',
...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@deepseek-ai\/dsh-client-web\/auth$/, replacement: src('../../packages/client/web/src/auth.tsx') },
