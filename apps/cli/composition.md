...
flowchart LR
  ...
  plugin_dsh_base_session_delivery["session-delivery<br/>@deepseek-ai/dsh-session-delivery-local"]
  cfg --> plugin_dsh_base_session_delivery
  ...
  plugin_dsh_base_context_reset["context-reset<br/>@deepseek-ai/dsh-context-reset"]
  cfg --> plugin_dsh_base_context_reset
  plugin_dsh_base_command_reset["command-reset<br/>@deepseek-ai/dsh-command-reset"]
  cfg --> plugin_dsh_base_command_reset
  ...
  plugin_dsh_base_tool_result_artifacts["tool-result-artifacts<br/>@deepseek-ai/dsh-tool-result-artifacts"]
  cfg --> plugin_dsh_base_tool_result_artifacts
  ...
  plugin_dsh_base_tool_session_query["tool-session-query<br/>@deepseek-ai/dsh-tool-session-query"]
  cfg --> plugin_dsh_base_tool_session_query
  plugin_dsh_base_tool_session_delivery["tool-session-delivery<br/>@deepseek-ai/dsh-tool-session-delivery"]
  cfg --> plugin_dsh_base_tool_session_delivery
  ...
  plugin_dsh_base_context_snapshot["context-snapshot<br/>@deepseek-ai/dsh-context-snapshot"]
  cfg --> plugin_dsh_base_context_snapshot
  plugin_dsh_base_context_nudge["context-nudge<br/>@deepseek-ai/dsh-context-nudge"]
...
| `context-reset` | `@deepseek-ai/dsh-context-reset` |
| `command-reset` | `@deepseek-ai/dsh-command-reset` |
...
| `tool-result-artifacts` | `@deepseek-ai/dsh-tool-result-artifacts` |
