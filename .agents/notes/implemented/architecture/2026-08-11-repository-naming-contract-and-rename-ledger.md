...
| `@deepseek-ai/dsh-workspace-context`, `context/workspace-context/` | `@deepseek-ai/dsh-agent-instructions`, `context/agent-instructions/` | The package loads hierarchical `AGENTS.md`, `AGENTS.local.md`, and supported custom instruction files for the agent. `CLAUDE.md` and `CLAUDE.local.md` are unsupported. It is not general workspace context. |
