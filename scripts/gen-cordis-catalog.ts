...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  compactionHistory: 'compaction.md',
  contextInspector: 'compaction.md',
  cordisInspect: 'extensions.md',
  credentials: 'credentials.md',
  directoryPicker: 'workspace.md',
  dynamicCordisRunner: 'extensions.md',
  fs: 'filesystem.md',
  fileReferences: 'filesystem.md',
  goals: 'goal.md',
  hmrCoordination: 'extensions.md',
  webServer: 'web-server.md',
  invariants: 'invariants.md',
  pluginDiagnostics: 'plugin-diagnostics.md',
  ...
  terminalController: 'terminal-controller.md',
  browserController: 'browser-controller.md',
  sandbox: 'sandbox.md',
  sandboxPolicy: 'sandbox.md',
  contextReset: 'session.md',
  scheduler: 'schedule.md',
  sessionPersistence: 'persistence.md',
  sessionQuery: 'session-query.md',
  sessionDelivery: 'session-query.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  clientAuthentication: 'client-side bootstrap-adopted Cordis Service — packages/client/authentication/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AgentHandle: 'core.md',
  ModelSelection: 'model-policy.md',
  ...
  FileReferenceCandidate: 'filesystem.md',
  ...
  CodeRunRequest: 'ptc-runtime.md',
  CodeRunResult: 'ptc-runtime.md',
  CompactionProgress: 'compaction.md',
  CompactionResult: 'compaction.md',
  CompactionHistoryNode: 'compaction.md',
  CompactionTrigger: 'compaction.md',
  CompactionSummaryExpansion: 'compaction.md',
  CompactionSummaryExpansionOptions: 'compaction.md',
  CompactionSummaryId: 'compaction.md',
  CompactionSummarySearchHit: 'compaction.md',
  CompactionSummarySource: 'compaction.md',
  ...
  CommandImageAttachment: 'commands.md',
  ...
  SessionHistoryPage: 'persistence.md',
  SessionHistoryPageRequest: 'persistence.md',
  SessionRawArtifact: 'persistence.md',
  SessionRawEventPage: 'persistence.md',
  SessionRawEventPageRequest: 'persistence.md',
  ...
  TerminalAttachmentId: 'terminal-controller.md',
  TerminalCreateRequest: 'terminal-controller.md',
  TerminalEnvironment: 'terminal-controller.md',
  TerminalFrame: 'terminal-controller.md',
  TerminalRetentionFrame: 'terminal-controller.md',
  TerminalShell: 'terminal-controller.md',
  WebTerminalId: 'terminal-controller.md',
  WebTerminalInfo: 'terminal-controller.md',
  BrowserAttachmentId: 'browser-controller.md',
  BrowserCreateRequest: 'browser-controller.md',
  BrowserFrame: 'browser-controller.md',
  BrowserImageFrame: 'browser-controller.md',
  BrowserInputEvent: 'browser-controller.md',
  BrowserNavigationAction: 'browser-controller.md',
  HostBrowserEnvironment: 'browser-controller.md',
  HostBrowserPageId: 'browser-controller.md',
  HostBrowserPageInfo: 'browser-controller.md',
  ...
  SessionCreateReceipt: 'session-query.md',
  SessionCreateRequest: 'session-query.md',
  SessionFindHit: 'session-query.md',
  SessionFindRequest: 'session-query.md',
  SessionLineageTrace: 'session-query.md',
  SessionLogTail: 'session-query.md',
  ...
  PresetCompositionCatalog: 'capabilities.md',
  ...
  ChildModelRoute: 'subagent.md',
  ChildProfileGrant: 'subagent.md',
  ChildProfileSetup: 'subagent.md',
  ChildProfileSpec: 'subagent.md',
  ResolvedChildProfile: 'subagent.md',
  SubagentDescendantListEntry: 'subagent.md',
  SubagentFollowupOptions: 'subagent.md',
  SubagentInterruptAuthority: 'subagent.md',
  SubagentInvocation: 'subagent.md',
  SubagentInvocationMode: 'subagent.md',
  ...
  AuthenticationAccessToken: 'authentication.md',
  AuthenticationCapability: 'authentication.md',
  AuthenticationChallenge: 'authentication.md',
  AuthenticationChallengeProof: 'authentication.md',
  AuthenticationChallengePurpose: 'authentication.md',
  AuthenticationDecision: 'authentication.md',
  AuthenticationEnrollmentApproval: 'authentication.md',
  AuthenticationEnrollmentId: 'authentication.md',
  ...
  AuthenticationPrincipal: 'authentication.md',
  AuthenticationStatus: 'authentication.md',
  BrowserAuthenticationDecision: 'authentication.md',
  AuthenticationRevocation: 'authentication.md',
  ...
  WebProvider: 'web.md',
  WebProviderCapability: 'web.md',
  WebProviderInfo: 'web.md',
  ...
  PluginDiagnosticCheck: 'plugin-diagnostics.md',
  ...
  CapabilityDescriptor: 'capabilities.md',
  CapabilityKind: 'capabilities.md',
  CapabilityObservation: 'capabilities.md',
  CapabilityPlan: 'capabilities.md',
  CapabilityPlanBlocker: 'capabilities.md',
  CapabilityPlanOperation: 'capabilities.md',
  CapabilityCompositionChange: 'capabilities.md',
  CapabilityCompositionSnapshot: 'capabilities.md',
  CapabilityRuntimeEntry: 'capabilities.md',
  CapabilityRuntimeStatus: 'capabilities.md',
  CapabilitySelectionValue: 'capabilities.md',
  SessionCapabilitySnapshot: 'capabilities.md',
  CapabilityProvenance: 'capabilities.md',
  CapabilityTarget: 'capabilities.md',
  CapabilityView: 'capabilities.md',
  ...
  ModelProfileDescriptor: 'model-policy.md',
  ModelProfileSettings: 'model-policy.md',
  ModelProfileSnapshot: 'model-policy.md',
  ModelRoute: 'model-policy.md',
  ModelRouteDescriptor: 'model-policy.md',
  ModelRouteSettings: 'model-policy.md',
  ModelRouteSnapshot: 'model-policy.md',
  ModelTarget: 'model-policy.md',
  ...
  SupervisionMode: 'supervision.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  QueueTopicStats: 'topic aggregate is owned by packages/queue/queue/README.md',
  QueueTopicInfo: 'topic record is owned by packages/queue/queue/README.md',
  QueueMessageInfo: 'message record is owned by packages/queue/queue/README.md',
  QueueSubscriptionInfo: 'subscription relation row is owned by packages/queue/queue/README.md',
  Array: 'Array is a TypeScript foundation type rendered inline by the catalog',
  ...
  SessionUnloadRequest: 'safe unload input is owned by packages/session-query/session-delivery/README.md',
  SessionUnloadReceipt: 'safe unload acknowledgement is owned by packages/session-query/session-delivery/README.md',
  SessionRuntimeStatus: 'runtime query snapshot is owned by packages/session-query/session-query/README.md',
  SessionMessageTail: 'message-tail query snapshot is owned by packages/session-query/session-query/README.md',
  McpUserConfigSettingsConfig: 'user MCP settings schema is owned by packages/mcp/mcp-user-config/README.md',
